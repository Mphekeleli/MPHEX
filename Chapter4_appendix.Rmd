...
We will use "LossesIndicator" as the dependent variable, while the \texttt{TradedDay} and \texttt{Desk} variables will be predictor variables. This will be our global model
